            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="d-flex flex-row-reverse">
                        <a href="{{ route('admin.units.create') }}" class="btn btn-success">Create</a>
                    </div>
                </div>
                <div class="card-body">
                    <table class="table table-hover table-striped">
                        ...
                        @foreach ($units as $unit)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.units.edit', $unit->id) }}" class="btn btn-success">Edit</a>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <mark>{{ $unit->title }}</mark> will be deleted. Are you sure to delete ?
                                        </div>
